...
import com.wf.model.aop.onecglib.CglibConfiguration;
...
public class ApplicationContextXmlTest {
    ...
    public static void main(String[] args) {
		...
		ClassPathXmlApplicationContext applicationContext  = new ClassPathXmlApplicationContext("model/aop/aop.xml");
