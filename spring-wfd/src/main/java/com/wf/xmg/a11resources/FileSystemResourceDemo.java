...
//  FileSystemResource  变成带编码的 EncodedResource ，被代理，还是被装饰呢？
...
public class FileSystemResourceDemo {
	...
	public static void main(String[] args) throws IOException {
		...
		String currentJavaFilePath = System.getProperty("user.dir") + "/resource/src/main/java/com/wf/xmg/a11resources/FileSystemResourceDemo.java";
