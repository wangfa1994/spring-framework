...
public class AOPProxyFactoryBeanTest {
	...
	private static void proxyFactory() {
		...
		proxyFactory.addAdvice(new EchoServiceMethodInterceptor()); // 这种形式Advice都会被封装成对应的DefaultPointcutAdvisor
	...
	private static void proxyFactoryBean() {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("classpath:/META-INF/aop02/a05/aspect.xml");
